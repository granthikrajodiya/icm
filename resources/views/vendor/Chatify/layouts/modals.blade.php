...
<div class="app-modal" data-name="settings">
    <div class="app-modal-container">
        <div class="app-modal-card" data-name="settings" data-modal='0'>
            <form id="update-settings" action="{{ route('avatar.update',tenant('tenant_id')) }}"
                ...
                <div class="app-modal-body">
                    ...
                    @else
                        <div class="avatar av-l upload-avatar-preview"
                             style="background-image: url('{{ asset('/storage/'.config('chatify.user_avatar.folder').'avatars/avatar.png') }}');"></div>
                    @endif
                    ...
                    <p class="app-modal-header">Dark Mode <span class="
                        {{ user()->dark_mode > 0 ? 'fas' : 'far' }} fa-moon dark-mode-switch"
                                                                data-mode="{{ user()->dark_mode > 0 ? 1 : 0 }}"></span>
                    </p>
