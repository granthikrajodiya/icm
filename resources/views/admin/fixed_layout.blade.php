...
@endpush
{{--Top Layout--}}
<div class="row fixed-layout-display">
    ...
    @foreach ($layouts['top'] as $top)
        ...
        @if ($top->content_type == 'Documents')
            <div class="{{$top->returnClass()}} col-auto">
                <div class="card"  style="height:{{$layouts['top_card_height']}}" >
        ...
        @elseif($top->content_type == 'Calendar')
            <div class="{{$top->returnClass()}} col-auto">
                ...
                @endphp
                <div class="card widget-calendar" style="height:{{$layouts['top_card_height']}}" >
                    <div class="card-header">
                    ...
                    <div class="card-display" data-toggle="{{$calendar_id}}-calendar"></div>
                </div>
                @push('script')
                    <script>
        ...
        @elseif($top->content_type == 'Custom HTML')
            <div class="{{$top->returnClass()}} col-auto">
                <div class="card" style="height:{{$layouts['top_card_height']}}" >
                    ...
                    <div class="card-body">
                        <iframe id="fixedHtmlTopFrame" src="{!! $top->data_source !!}"  data-src="{!! $top->data_source !!}" frameborder="0" style="height:200px;width: 100%"   data-title="{!! $top->title !!}"                  allowfullscreen>
                        </iframe>
                    </div>
                </div>
            </div>
        ...
        @elseif($top->content_type == 'News Feed')
            ...
            @endphp
            <div class="{{$top->returnClass()}} col-auto">
                <div class="card overflow-auto" style="height:{{$layouts['top_card_height']}}">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
    ...
    @foreach ($layouts['middle'] as $middle)
        ...
        @if ($middle->content_type == 'Documents')
            <div class="{{$middle->returnClass()}} col-auto">
                <div class="card" style="height:{{$layouts['middle_card_height']}}">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                        ...
                                        <div class="card mb-3 border shadow-none">
                                            <div class="px-3 py-3">
                                                <div class="row align-items-center">
                                                    <div class="col ml-n2">
                                                        <h6 class="text-sm mb-0 text-center">
                                                        {{__('An error occurred retrieving the list of ') . $middle->plural_item . '. ' . __('Please contact your system administrator and reference error: ')}}
                                                        </h6>
                                                    </div>
                                                </div>
                                            </div>
        ...
        @elseif($middle->content_type == 'Calendar')
            ...
            @endphp
            <div class="{{$middle->returnClass()}} col-auto">
                <div class="card widget-calendar" style="height:{{$layouts['middle_card_height']}}">
                    <div class="card-header">
                        <div class="text-sm text-muted mb-1 layout-calendar-year"></div>
                        <a href="{{ route('calendar.index',tenant('tenant_id')) }}">
                            <div class="h5 mb-0 layout-calendar-day text-primary"></div>
        ...
        @elseif($middle->content_type == 'Custom HTML')
            <div class="{{$middle->returnClass()}} col-auto">
                <div class="card" style="height:{{$layouts['middle_card_height']}}">
                    ...
                    <div class="card-body">
                        <iframe id="fixedHtmlMiddleFrame" src="{!! $middle->data_source !!}"   data-src="{!! $middle->data_source !!}" frameborder="0" style="height:200px;width: 100%;"  data-title="{!! $middle->title !!}"
    ...
    @foreach ($layouts['bottom'] as $bottom)
        ...
        @if ($bottom->content_type == 'Documents')
            <div class="{{$bottom->returnClass()}} col-auto">
                <div class="card" style="height:{{$layouts['bottom_card_height']}}">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
        ...
        @elseif($bottom->content_type == 'Calendar')
            <div class="{{$bottom->returnClass()}} col-auto">
                ...
                @endphp
                <div class="card widget-calendar" style="height:{{$layouts['bottom_card_height']}}">
                    <div class="card-header">
                        <div class="text-sm text-muted mb-1 layout-calendar-year"></div>
                        <a href="{{ route('calendar.index',tenant('tenant_id')) }}">
                            <div class="h5 mb-0 layout-calendar-day text-primary"></div>
        ...
        @elseif($bottom->content_type == 'Custom HTML')
            <div class="{{$bottom->returnClass()}} col-auto">
                <div class="card" style="height:{{$layouts['bottom_card_height']}}">
                    ...
                    <div class="card-body">
                        <iframe id="fixedHtmlBottomFrame" src="{!! $bottom->data_source !!}"  data-src="{!! $bottom->data_source !!}"  frameborder="0" style="height:200px;width: 100%;"  data-title="{!! $bottom->title !!}"
                                allowfullscreen></iframe>
                    </div>
                </div>
            </div>
...
@push('script')
    ...
    <script type="text/javascript">
        ...
        //custom HTML for top
        if(document.getElementById('fixedHtmlTopFrame')) {
            PassFormInfo('fixedHtmlTopFrame');
        };

        //custom HTML for middle
        if(document.getElementById('fixedHtmlMiddleFrame')){
            PassFormInfo('fixedHtmlMiddleFrame');
        };

        //custom HTML for bottom
        if(document.getElementById('fixedHtmlBottomFrame')){
            PassFormInfo('fixedHtmlBottomFrame');
        };
