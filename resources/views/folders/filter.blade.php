                                ...
                                @if (!$filterVal->Hidden)
                                    ...
                                    @elseif($filterVal->FieldType == 3)
                                        <div class="col-md-4">
                                            ...
                                            @php
                                                $date_default_val = '';
                                                if ($filterVal->DefaultValue == 'Use current date') {
                                                    $date_default_val = json_encode([date('Y/m/d'), date('Y/m/d')]);
                                                } elseif ($filterVal->DefaultValue != '' && $filterVal->DefaultValue != null) {
    ...
    @push('script')
        <script type="text/javascript">
            ...
            function loadDataTable() {
                ...
                // $(".dataTable th").first().click().click(); // Setting the datatable for descending order
            }
