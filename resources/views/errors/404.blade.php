        ...
        <div class="container position-relative zindex-100">
            <div class="row justify-content-center align-items-center">
                <div class="col-lg-6">
                    ...
                    <a href="{{ (\Auth::check()) ? route('home',tenant('tenant_id')) : url('/home') }}" class="btn btn-white btn-icon rounded-pill hover-translate-y-n3">
                ...
                <div class="col-lg-6 d-none d-lg-block">
                    <figure class="w-100">
                        <img alt="Image placeholder" src="{{ asset('assets/img/svg/illustrations/design-thinking.svg') }}" class="svg-inject opacity-8 img-fluid" style="height: 500px;">
                    </figure>
                </div>
            </div>
        </div>
