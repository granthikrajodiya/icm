...
<head>
    ...
    <title><?php echo e((Utility::getValByName('header_text')) ?? config('app.name')); ?></title>
    <link rel="shortcut icon" href="<?php echo e(asset('landingpage/assets/images/favicon.png')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('landingpage/assets/css/main-style.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('landingpage/assets/css/responsive.css')); ?>">
</head>
...
<body>
            ...
            <div class="main-navigationbar">
                <div class="navigationbar-row d-flex justify-content-between align-items-center">
                    <div class="logo-col">
                        <h1>
                            <a href="index.html">
                                <img src="<?php echo e(tenant()?->logo_path ?? asset('assets/img/base_img/logo.png')); ?>" alt="">
                            </a>
                        </h1>
                    </div>
                    <div class="header-info-right">
                        <ul class="menu-right d-flex justify-content-end">
                            <?php if(isset($tenantId) && !empty($tenantId)): ?>
                                <li><a href="<?php echo e(route('login',$tenantId)); ?>" class="btn"><?php echo e(__('Login')); ?></a></li>
                                <?php if(tenant()->user_register): ?>
                                    <li><a href="<?php echo e(route('register',$tenantId)); ?>" class="btn"><?php echo e(__('Register')); ?></a></li>
                                <?php endif; ?>
                            <?php endif; ?>
                        </ul>
                    </div>
    ...
    <div class="wrapper">
        <section class="main-home-first-section">
            <div class="banner-image">
                <img src="<?php echo e(asset('landingpage/assets/images/banner-img.png')); ?>" alt="">
            </div>
            <div class="container">
                <div class="home-banner-content">
                    <div class="home-banner-content-inner">
                        <img src="<?php echo e(asset('landingpage/assets/images/ILINX-Logo.png')); ?>" alt="">
                        <h2 class="h1"><?php echo e(__('ENGAGE')); ?></h2>
                        <h4><?php echo e(__('Bring your back office document and process information into the front office and beyond.')); ?></h4>
                        <?php if(isset($tenantId) && !empty($tenantId)): ?>
                            <?php if(tenant()->user_register): ?>
                                <a href="<?php echo e(route('register',$tenantId)); ?>" class="btn"><?php echo e(__('Register')); ?></a>
                            <?php endif; ?>
                        <?php endif; ?>
                    </div>
                </div>
        ...
        <section class="dashboard-preview-section padding-bottom">
            <div class="container">
                <div class="dashboard-preview-image">
                    <img src="<?php echo e(asset('landingpage/assets/images/dash-board.png')); ?>" alt="">
                </div>
            </div>
        </section>
        <section class="user-centric-section padding-bottom">
            <div class="container">
                <div class="section-title text-center">
                    <h2><?php echo e(__('Put any of your process information into a')); ?> <br> <?php echo e(__('user-centric experience.')); ?></h2>
                </div>
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-12 experience-card">
                        <div class="experience-card-inner">
                            ...
                            <h4><?php echo e(__('Initiate')); ?></h4>
                            <p><?php echo e(__('Start processes via built-in workflow, eForms and real-time chat.')); ?></p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-12 experience-card">
                        <div class="experience-card-inner">
                            ...
                            <h4><?php echo e(__('Collaborate')); ?></h4>
                            <p><?php echo e(__('Publish and share documents, lists, calendars, and charts.')); ?></p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-12 experience-card">
                        <div class="experience-card-inner">
                            ...
                            <p><?php echo e(__('Add and remove capabilities with no-code, drag-drop functions.')); ?></p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-12 experience-card">
                        <div class="experience-card-inner">
                            ...
                            <h4><?php echo e(__('Multi-tenant')); ?></h4>
                            <p><?php echo e(__('Support multiple groups both inside and out with a single deployment.')); ?></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="user-forever-section  padding-bottom">
            <div class="section-back">
                <img src="<?php echo e(asset('landingpage/assets/images/back-shape.png')); ?>" alt="">
            </div>
            <div class="container">
                 <div class="user-forever-content">
                    <div class="section-title text-center">
                        <h2><?php echo e(__('Change the way you serve your users. ')); ?><br> <?php echo e(__('Forever.')); ?></h2>
                    </div>
        ...
        <section class=" users-love-section padding-top">
                ...
                <div class="row align-items-center">
                    <div class="col-md-6 col-12">
                        <div class="user-love-img">
                            <img src="<?php echo e(asset('landingpage/assets/images/user-love.png')); ?>" alt="">
                        </div>
                    </div>
                    <div class="col-md-6 col-12">
            ...
            <div class="testimonial padding-top">
                <div class="top-shape">
                    <img src="<?php echo e(asset('landingpage/assets/images/rt.png')); ?>" alt="">
                </div>
    ...
    <footer class="site-footer">
        <img src="<?php echo e(asset('landingpage/assets/images/footer-mask.png')); ?>" class="back-mask" alt="">
        <div class="container">
            ...
            <div class="footer-middle">
                <div class="ft-logo-col">
                    <a href="index.html">
                        <img src="<?php echo e(asset('landingpage/assets/images/footer-logo.png')); ?>" alt="">
                    </a>
                </div>
    ...
    <!--scripts start here-->
    <script src="<?php echo e(asset('landingpage/assets/js/jquery.min.js')); ?>"></script>
    <script src="<?php echo e(asset('landingpage/assets/js/slick.min.js')); ?>" defer="defer"></script>
    <script src="<?php echo e(asset('landingpage/assets/js/custom.js')); ?>" defer="defer"></script>
    <!--scripts end here-->
</body>

</html>
<?php /**PATH /var/www/html/ICM/ILINXEngage (6-26-2023)/ILINXEngage/resources/views/landing/index.blade.php ENDPATH**/ ?>